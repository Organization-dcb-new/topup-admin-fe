        ...
        <div className='flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between'>
          <div className='flex gap-3'>
            ...
            <div className='min-w-0 space-y-1'>
              <h1 className='text-2xl font-semibold tracking-tight text-gray-900'>{t('bannerPage.title')}</h1>
              <p className='text-sm text-muted-foreground'>{t('bannerPage.subtitle')}</p>
            </div>
          </div>
        ...
        <div className='overflow-hidden rounded-xl bg-white shadow-sm ring-1 ring-gray-900/5'>
          <div className='flex flex-col gap-3 border-b border-gray-100 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-5'>
            <div className='min-w-0 space-y-0.5'>
              <h2 className='text-sm font-semibold text-gray-900'>{t('bannerPage.listTitle')}</h2>
              <p className='text-xs text-muted-foreground'>{t('bannerPage.listHint')}</p>
            </div>
            <CreateBannerModal />
          </div>
            ...
            {isPending && (
              ...
              >
                ...
                <div className='text-center'>
                  <p className='text-sm font-medium text-foreground'>{t('bannerPage.tableLoadingTitle')}</p>
                  <p className='mt-1 text-xs text-muted-foreground'>{t('bannerPage.tableLoadingHint')}</p>
                </div>
              </div>
            )}
            {isError && <ErrorComponent message={t('bannerPage.loadErrorDetail')} />}
            {isSuccess && (
              <DataTable
