  ...
  return (
    <DashboardLayout>
      <div className="mx-auto flex min-h-[min(70vh,32rem)] max-w-lg flex-col items-center justify-center px-4 text-center">
        ...
        <h1 className="mt-2 text-2xl font-semibold tracking-tight text-gray-900">Halaman tidak ditemukan</h1>
        <p className="mt-3 text-sm text-muted-foreground">
          Alamat yang Anda buka tidak ada atau sudah dipindahkan. Periksa URL atau kembali ke dasbor.
        </p>
