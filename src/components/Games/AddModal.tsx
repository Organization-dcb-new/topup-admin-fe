...
export function AddGameModal({ open, onClose, onSuccess }: Props) {
  const { register, handleSubmit, setValue, reset } = useForm<AddGamePayload>()
  ...
  const onSubmit = async (data: AddGamePayload) => {
